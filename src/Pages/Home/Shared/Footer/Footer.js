...
const Footer = () => {
    return (
        <div className='shadow-2xl mt-9 '>
            <footer className="footer footer-center p-10 bg-violet-500 text-dark-content">
                <div>
                    ...
                    <p className="font-bold">
                        SHOPPER STOP Industries Ltd. <br />Providing reliable tech since 1992
                    </p>
